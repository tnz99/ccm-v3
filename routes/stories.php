...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/stories/search', [StoryController::class, 'search'])->name('stories.search');
    Route::delete('/stories/delete', [StoryController::class, 'delete'])->name('stories.delete');
});