            ...
            <div class="mt-4 flex justify-center w-full">
                <table class="w-full">
                    <thead class="bg-green-900">
                        <th class="text-white text-center">Year</th>
                        <th class="text-white text-center">Main Story Line</th>
                    ...
                    <tbody>
                        @foreach ($timelines as $timeline )
                            <tr>
                                ...
                                <td class="text-center">{{ $timeline->headline->title }}</td>
                                <td class="text-center">
                                    <a href="{{ route('timelines.edit', ['id' => $timeline->id ]) }}">Edit</a>
                                    <a href="">Delete</a>
                                </td>
                            </tr>
                        @endforeach
