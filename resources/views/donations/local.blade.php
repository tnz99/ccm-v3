<x-page-layout backgroundImageName="/images/upload/donate.png" :darkMode='false' cnavBackground="linear-gradient(270deg, #BABC46 42%, rgba(188, 219, 240, 0.40) 101.31%)" :blur="false">
    <div class="flex flex-col mt-0 xl:mt-8 w-full">
        ...
        <div class="flex w-full xl:w-6/12 mt-0 xl:mt-2">
            <a href="{{ route('donations.international.get') }}" class="cursor-default flex justify-center w-full capitalize font-inter text-xs font-bold p-2 bg-black text-[#FCFF5C]">international donation</a>
            <a href="{{ route('donations.local') }}" class="cursor-default flex justify-center w-full capitalize font-bold p-2 font-inter text-xs text-black bg-[#FCFF5C]">local donation</a>
        </div>
    </div>
    <div class="flex w-full flex-col xl:flex-row">
        <img src="/images/upload/localQR.jpeg" alt="" class="h-auto w-12 xl:w-64" >
        <div class="flex xl:w-3/12">
            ...
            <div>
                <x-input-label for="journal_number" :value="__('Journal Number')" />
