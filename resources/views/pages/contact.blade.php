<x-page-layout backgroundImageName="images/contact.png" :darkMode="false" cnavBackground="linear-gradient(270deg, #1f3642 42.11%, rgba(188, 219, 240, 0.40) 101.31%)" :blur="false">
    <div class="flex flex-col xl:flex-row items-center w-full gap-10 pt-20 xl:px-12 xl:pt-40">
        ...
        <div class="flex gap-4">
            <div class="p-4 text-black bg-yellow-200 rounded-lg flex justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </div>
