<x-page-layout backgroundImageName="images/contact.png" :darkMode="true" cnavBackground="linear-gradient(270deg, #DA8495 42.11%, rgba(216, 161, 164, 0.56) 101.31%)">
    <div class="flex items-center w-full gap-6 pt-40">
