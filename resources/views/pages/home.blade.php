<x-page-layout backgroundImageName="images/home.png" :darkMode="false" cnavBackground="linear-gradient(270deg, #151A21 42.11%, rgba(23, 28, 36, 0.06) 101.31%)" :blur="false">
    ...
    <a href="{{ route('donations.international') }}" class="w-36 p-2 rounded-sm cursor-default flex justify-center gap-5 items-center bg-[#FCFF5C] hover:bg-yellow-300 xl:w-44">
