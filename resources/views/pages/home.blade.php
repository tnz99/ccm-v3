<x-page-layout backgroundImageName="images/home.png" :darkMode="false" cnavBackground="linear-gradient(270deg, #151A21 42.11%, rgba(23, 28, 36, 0.06) 101.31%)">
    ...
    <a href="{{ route('donations.international') }}" class="w-36 p-2 px-6 rounded-sm cursor-default flex justify-between items-center bg-yellow-200 hover:bg-yellow-300 xl:w-36">
