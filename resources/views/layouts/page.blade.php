...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-image: url('{{ $backgroundImageName }}')" class="w-full h-full flex flex-col bg-center items-center lg:bg-no-repeat lg:bg-cover lg:bg-left-top overflow-hidden">
        @if (session('success'))
        <div id="toast-success" class="fixed mt-8 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-green-100 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        @if (session('error'))
        <div id="toast-danger" class="fixed mt-8 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-red-100 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
