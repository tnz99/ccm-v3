        ...
        <div class="p-5 border border-b-0 border-gray-200">
            <div class="p-4">
                <form action="{{ route('galleries.update') }}" method="post" enctype="multipart/form-data" class="flex flex-col gap-2">
                    ...
                    <button type="submit" class="self-end text-xs uppercase inline-flex items-center px-3 py-2 mt-4 mt-6font-medium text-center text-white bg-green-800 rounded-sm focus:ring-4 focus:ring-primary-200 hover:bg-white hover:text-green-800 hover:border hover:border-solid hover:border-green-800">
                        Save Changes
                    </button>
                </form>
            </div>
