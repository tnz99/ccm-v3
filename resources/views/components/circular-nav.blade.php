...
<nav id="circular_nav" class="animate__animated animate__zoomIn animate__faster bg-gray-800 bg-gradient-to-t fixed hidden sm:h-wvh sm:w-wvh rounded-full md:left-[76%] 2xl:left-[80%] top-0">
    <div class="flex justify-center items-center">
        ...
        <a class="hover:bg-gradient-to-l from-black to-white flex gap-4 text-white capitalize text-sm py-2 px-6 w-auto text-left rounded-xl font-medium absolute top-[46.5%] left-[0%]"    href="{{ route('pages.story', '4') }}">The Change<x-logos.story-nav /></a>
        <a class="hover:bg-gradient-to-l from-black to-white flex gap-4 text-white capitalize text-sm py-2 px-6 w-auto text-left rounded-xl font-medium absolute top-[59%] left-[3%]"  href="{{ route('pages.story', '5') }}">The Climate<x-logos.story-nav /></a>
