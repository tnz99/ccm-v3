<section class="flex flex-col items-start sm:items-center w-full sm:flex-row mt-4">
    ...
    <ul class="w-full hidden xl:flex flex-col justify-end sm:flex-row">
        ...
        @auth
            @if(auth()->user()->isDonar())
                ...
                <li><a href="{{ route('donars.profile') }}" class="uppercase text-sm font-thin hover:bg-yellow-300 p-2 px-5 {{ $darkMode ? 'text-white' : 'text-black'}}">Profile</a></li>
