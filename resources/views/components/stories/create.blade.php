                ...
                <form action="{{ route('stories.create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select name="parent_story_id" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="main_story">The Climate</option>
                                <option value="slider_layout">The Law</option>
                                <option value="year_layout">The People</option>
                            </select>
                        </div>

                        <div class="sm:col-span-2">
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Layout</label>
                            <select name="layout_name" class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option value="main_story">Main Story</option>
                                <option value="slider_layout">Gallery</option>
                                <option value="year_layout">Timeline</option>
                            </select>
                        </div>


                        <div class="sm:col-span-2">
                            <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Page</label>
